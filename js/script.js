    ...
    if(usuarios.length > 0){
        ...
        for (const u of usuarios) {
            if(u.email === dadosForm.email && u.senha === dadosForm.senha){
             ...
             //TIMER COM INJEÇÃO DA MSG DE SUCESO
             ...
             //Adicionando uma nova tag a esta div capturada com a propriedade innerHTML.
                divMsg.innerHTML = "<p>Login realizado com SUCESSO!</p><p>Você sera redirecionado em 5 segundos...</p>";
