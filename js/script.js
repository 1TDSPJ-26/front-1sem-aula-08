    ...
    if(usuarios.length > 0){
        ...
        for (const u of usuarios) {
            if(u.email === dadosForm.email && u.senha === dadosForm.senha){
                ...
                divMsg.innerHTML = "<p>Login realizado com SUCESSO!</p><p>Redirecionando em 5 segundos...</p>";
                let contador = 5;
                const intervalo = setInterval(()=>{
                  contador--;
                  divMsg.innerHTML = `<p>Login realizado com SUCESSO!</p><p>Redirecionando em ${contador} segundos...</p>`;
